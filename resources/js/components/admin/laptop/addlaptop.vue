<template>
	<div class="container">
		...
		<div class="row">
			<a :href="laptop_url">
					<button class="btn btn-danger btn-red mr-2" id='back'>
		...
		<div class="row pt-3">
			<div class="card">
				...
				<div class="card-body">
					<form class="md-form" @submit.prevent='AddLaptop'>
						<div class="row">
							<div class="col-md-4">
			              ...
			              <div class="card-body text-center">
				              <figure class="featured-image-preview" v-if='form.featured_image!=null'>
				                <img :src="form.featured_image" id='preview_image' alt="">
				                <figcaption>
				              ...
				              <div class="file-field text-center">
										    <div class="file btn btn-primary btn-blue font-white">
													<i class="fa fa-plus mr-10px"></i>Add featured image
								...
								<div class="card">
									...
									<div class="card-body">
									  ...
									  <div class="file-field  row justify-content-center">
									  	<button class="btn btn-danger btn-red mr-2" v-if='form.related_images.length>1' @click='removeAllRelatedImage'><i class="fa fa-trash mr-10px"></i>Clear all</button>
									    <div class="file btn btn-primary btn-blue font-white">
												<i class="fa fa-plus mr-10px"></i>Add related images
							  ...
							  <!-- display -->
								...
								<div class="card">
									<div class="card-header text-center">
										<button class="btn btn-success btn-grn" type='submit'><i class="fa fa-check mr-2"></i>Publish</button>
									</div>
								</div>
...
<script>
	export default{
        ...
        reader.readAsDataURL(f); 
			...
			AddLaptop(){
				this.loading=true;
				this.form.post(this.laptop_url+'/add/').then(()=>{
					Toast.fire({
            icon: 'success',
