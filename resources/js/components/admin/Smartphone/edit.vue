<template>
    ...
    <loader v-if='loading'></loader>
        ...
        <a href="/admin/smartphones/add" class="btn btn-primary btn-blue font-white mr-1">
...
<script>
    ...
    props:['smartphone'],
        ...
        reader.readAsDataURL(f); 
			...
			updateSmartphone(){
        this.loading=true;
				axios.post('/admin/smartphones/update',this.form).then(res=>{
					Toast.fire({
            icon: 'success',
      ...
      loadSmartphone(){
        this.form.fill(this.smartphone)
      }
