		...
		<div class="row justify-content-center">
			...
			<div class="col-md-6">
				<div class="brand_detail_image">
					<img src="/images/brands/{{ $brand->brand_image }}" alt="" style="width: 100%">

					<div class="col-md-12 text-center pt-4">
					 <a class="btn btn-blue view-product" style="color: white" href="{{ route('laptop.brands',['slug'=>$brand->slug]) }}" target="_blank">View Products</a>
						</div>
				</div>
			</div>
